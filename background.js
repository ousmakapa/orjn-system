  ...
  const [{ result }] = await chrome.scripting.executeScript({
    ...
    func: (selectors, monitorName) => {
      ...
      function extractProduct() {
        ...
        const COLORS = ["black","white","red","blue","green","yellow","orange","purple","pink","brown","grey","gray","navy","beige","cream","gold","silver","olive","tan","khaki","burgundy","maroon","teal","coral","lavender","violet","indigo","turquoise","mint","rose","crimson","charcoal","slate","sand","rust","copper","bronze"];
        ...
        const pickColors = (t) => { if (!t) return []; const l = t.toLowerCase(); return COLORS.filter((c) => l.includes(c)); };
        ...
        if (!r.color) { const cols = pickColors(searchText); if (cols.length) r.color = cols[0]; }
